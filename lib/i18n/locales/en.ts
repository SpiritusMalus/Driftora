export const en = {
  ...
  weight: {
    ...
    formula: {
      ...
      activityNote: 'This is about everyday walking, NOT workouts — log those separately under «Workouts» on the Food screen. By steps: sedentary — under 5k · light — 5–8k · moderate — 8–12k · high — 12k+ or a job on your feet. If you log steps, this level is just a baseline: movement above it is added to the budget automatically (same day), and setting «sedentary» hands the whole count to your steps.',
      bodyFat: 'Body fat %',
      bodyFatHint: 'e.g. 20',
  ...
  food: {
    ...
    day: {
      ...
      withMovement: 'Movement: {{detail}} → target with it {{target}} kcal',
      moveSteps: 'steps +{{kcal}}',
      moveWorkout: 'workouts +{{kcal}}',
    },
    parseIssue: {
