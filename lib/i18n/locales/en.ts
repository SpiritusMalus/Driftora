export const en = {
  ...
  micros: {
    ...
    source: 'Norms: IOM / US National Academies, adults 19–50; close to the WHO guidance.',
    disclaimer:
      'These are references for a healthy adult. Pregnancy, illness, medication and age change what you need — ask a doctor if in doubt.',
  },
  planScreen: {
    title: 'Nutrition plan',
    fromWeight: 'Based on your latest weight, {{kg}} kg',
    noWeight: 'No weigh-in yet — log one on «Weight»',
    logWeightCta: 'Log a weight',
  },
  more: {
    title: 'Sections',
    groups: {
    ...
    subtitles: {
      diary: 'Work a thought through: situation → emotion → reframe',
      days: 'Past days: food, weight, steps, mood',
      wins: 'What has already gone well',
      review: 'This week compared with last',
      plan: 'Goal, pace and your daily targets',
      settings: 'Privacy, targets, break',
      how: 'Where the numbers come from and how accurate they are',
    },
    dailyNote: 'Food, steps, workouts and weight live on the home screen; mood is one swipe left from it.',
  },
  ...
  weight: {
    ...
    planRow: {
      title: 'Nutrition plan',
      summary: '{{kcal}} kcal · P {{prot}} · F {{fat}} · C {{carb}}',
      empty: 'No daily target yet — open and work it out',
    },
    plan: {
      title: 'Nutrition plan',
  ...
  food: {
    ...
    dryWeight:
      'The weight looks like the dry product’s (a pack’s net weight) while the matched row is for the cooked dish — multiplying the two understates calories roughly 3×. We restated the composition on the dry product using standard cooking yields. If you weighed the cooked portion instead, pick the original row below.',
    refereeMismatch:
    ...
    micros: {
      ...
      normsHint: 'The dark tick is the daily norm, the amber tick the safe upper limit.',
    },
    detail: {
  ...
  review: {
    ...
    restart: {
      ...
      body: 'The weeks-in-a-row counter resets and starts from today. Your records stay put — food, weight, workouts and the diary are untouched; only the streak count changes.',
      confirm: 'Start over',
      cancel: 'Cancel',
      since: 'Streak counted from {{date}}',
    },
  ...
  subscription: {
    ...
    payNote: 'Card payment inside the app. Nothing auto-renews: a subscription is extended only by paying again.',
    payTitle: 'Payment',
    close: 'Close',
    ...
    errors: {
      ...
      invalid_key: 'We do not know that key. Check whether a character went missing.',
      unknown_plan: 'That plan is no longer sold. Reopen the screen.',
      not_selling: 'Subscriptions cannot be bought right now. Everything in the app keeps working for free.',
      no_install_id: 'The app is still starting up. Try again in a couple of seconds.',
      unreachable: 'Could not reach the server. Try again — no money is taken when this happens.',
      settle: 'We cannot see the payment yet. If you were charged, reopen this screen in a minute and it will switch on by itself.',
    },
  },
  backup: {
    title: 'Backup',
