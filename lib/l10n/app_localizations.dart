...
abstract class AppLocalizations {
  ...
  /// Supportive subtitle on the home dashboard
  ///
  /// In ru, this message translates to:
  /// **'Ваш день в одном экране'**
  ...
  /// No description provided for @sectionWins.
  ///
  /// In ru, this message translates to:
  /// **'Победы'**
  String get sectionWins;
  ...
  /// No description provided for @emptyHomeHint.
  ///
  /// In ru, this message translates to:
