...
export const colors: { light: ThemeColors; dark: ThemeColors } = {
  ...
  dark: {
    ...
    primary: '#F04E3C', // signal red, lifted for dark. History of the tone:
    // #FF7E6B read as «старый коралл» (2026-07-20), the redder #FF6250 turned
    // neon-orange against the cool blueprint — a warm accent on a cold dark
    // ground vibrates at full chroma («оранжевый не вырвиглазный?»,
    // 2026-07-21). This one keeps the red pencil without the neon.
