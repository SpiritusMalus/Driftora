...
export const RU_FOODS: RuFood[] = [
  ...
  { name: 'утка', aliases: ['утка', 'утиная грудка'], query: 'duck domesticated meat only cooked roasted' },
  { name: 'кролик', aliases: ['кролик', 'крольчатина'], query: 'game meat rabbit domesticated cooked roasted' },
  { name: 'печень куриная', aliases: ['куриная печень', 'печёнка куриная'], query: 'chicken liver all classes cooked simmered' },
  { name: 'язык говяжий', aliases: ['язык', 'говяжий язык'], query: 'beef tongue cooked simmered' },
  ...
  { name: 'форель', aliases: ['форель'], query: 'fish trout rainbow farmed cooked dry heat' },
  { name: 'судак', aliases: ['судак'], query: 'fish pike walleye cooked dry heat' },
  { name: 'щука', aliases: ['щука'], query: 'fish pike northern cooked dry heat' },
  { name: 'карп', aliases: ['карп'], query: 'fish carp cooked dry heat' },
  { name: 'окунь', aliases: ['окунь'], query: 'fish perch mixed species cooked dry heat' },
  { name: 'камбала', aliases: ['камбала'], query: 'fish flatfish flounder and sole species cooked dry heat' },
  ...
  { name: 'мидии', aliases: ['мидия'], query: 'mollusks mussel blue cooked moist heat' },
  ...
  { name: 'брюссельская капуста', aliases: ['брюссельская капуста'], query: 'brussels sprouts cooked boiled drained', prefer: 'without salt' },
  { name: 'стручковая фасоль', aliases: ['стручковая фасоль', 'зелёная фасоль'], query: 'beans snap green cooked boiled drained without salt' },
